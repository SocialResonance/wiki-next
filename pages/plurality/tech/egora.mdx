...
Lastly, Egora is free to use and protected by Copyleft. If you are dissatisfied with this Egora, you can create your own version of it, and you can use [the code of this Egora](https://github.com/CezaryJurewicz/Egora) to start. Egora welcomes all competition. May the best ideas win!